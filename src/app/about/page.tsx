...
export default function About() {
  ...
  return (
    <div className="min-h-screen">
      {/* Video Hero Section - Using Simple Debug Version */}
      <SimpleVideoHero />
      ...
      <div className="bg-neo-off-white">
        ...
        {/* Core Values */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-neo-dark-gray text-center mb-12">{t('about.values.title')}</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group relative bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-500 border-t-4 border-blue-500 animate-fade-in-up">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold text-neo-dark-gray mb-4 group-hover:text-blue-500 transition-colors duration-300">{t('about.values.innovation')}</h3>
                <p className="text-neo-gray leading-relaxed">
            ...
            <div className="group relative bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-500 border-t-4 border-emerald-500 animate-fade-in-up">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold text-neo-dark-gray mb-4 group-hover:text-emerald-500 transition-colors duration-300">{t('about.values.integrity')}</h3>
                <p className="text-neo-gray leading-relaxed">
            ...
            <div className="group relative bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-500 border-t-4 border-amber-500 animate-fade-in-up">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold text-neo-dark-gray mb-4 group-hover:text-amber-500 transition-colors duration-300">{t('about.values.excellence')}</h3>
                <p className="text-neo-gray leading-relaxed">
        ...
        {/* Global Presence */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-neo-dark-gray text-center mb-12">{t('about.global.title')}</h2>
